...
function ImprovePoliticsFrame() {
	if (!document.location.pathname.match(/\/politic\//))
		return;
		
	// resize list of diplomatic relations
	var stickers = getElementsByClassName('sticker', document, 'div');
	stickers[0].firstChild.className = 'longLAYER';
}
...
function MapExpand2(X, Y){
    ...
    var ts = document.getElementById('top_shit');
